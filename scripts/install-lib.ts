...
#   TARGET/.omp/agent/extensions/receipt/*.ts          receipt carriage + giwt ledger bridge
...
const AGENT_PAYLOADS: readonly [string, string][] = [
  ...
  ["extensions/util/giwt-config.ts", "extensions/util/giwt-config.ts"],
  ...
  ["extensions/receipt/receipt-doc.ts", "extensions/receipt/receipt-doc.ts"],
  ["extensions/receipt/receipt-carry.ts", "extensions/receipt/receipt-carry.ts"],
  ...
  ["extensions/commands/bookkeep/discover.ts", "extensions/commands/bookkeep/discover.ts"],
  ["extensions/commands/bookkeep/prompts.ts", "extensions/commands/bookkeep/prompts.ts"],
  ["extensions/commands/bookkeep/giwt.ts", "extensions/commands/bookkeep/giwt.ts"],
  ...
  ["extensions/commands/ticket/prompt.ts", "extensions/commands/ticket/prompt.ts"],
  ["extensions/commands/find-work/types.ts", "extensions/commands/find-work/types.ts"],
  ["extensions/commands/find-work/keywords.ts", "extensions/commands/find-work/keywords.ts"],
  ["extensions/commands/find-work/classify.ts", "extensions/commands/find-work/classify.ts"],
  ["extensions/commands/find-work/parse-args.ts", "extensions/commands/find-work/parse-args.ts"],
  ...
  ["extensions/commands/find-work/lint.ts", "extensions/commands/find-work/lint.ts"],
  [
    "extensions/commands/find-work/typecheck-tests.ts",
    "extensions/commands/find-work/typecheck-tests.ts",
  ],
  ["extensions/commands/find-work/knip-jscpd.ts", "extensions/commands/find-work/knip-jscpd.ts"],
  ["extensions/commands/find-work/doctor.ts", "extensions/commands/find-work/doctor.ts"],
  [
