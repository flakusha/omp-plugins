...
condition: ["node|bun|deno|nodejs|bunjs", "runtime|execution environment|platform|framework|portab|multi-env|works in (node|bun|deno)", "shim|polyfill|adapter|compat|process\\.env|node:fs|Bun\\.file"]
scope: ["text", "thinking"]
---
