...
condition: ["async|await|Promise|concurrent|parallel", "sequential|one by one|one at a time|blocking (call|loop)", "in parallel|at the same time|concurrently|fire off"]
scope: ["text", "thinking"]
---
