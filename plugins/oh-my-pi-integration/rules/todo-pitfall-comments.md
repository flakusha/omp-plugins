...
condition: ["TODO|FIXME|XXX|HACK", "pitfall|trap|gotcha|future (improvement|work|extension)|known (issue|limitation)|follow-up|when (this|that) (lands|changes|is added)"]
scope: ["text", "thinking"]
---
