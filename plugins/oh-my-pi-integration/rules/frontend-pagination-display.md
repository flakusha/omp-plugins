...
condition: ["frontend|client|ui|list|table|grid|display (results|items|rows)", "pagination|paginate|page size|show more|load more|infinite scroll|next page|items per page", "huge page|too many|slow device|memory (exhaust|pressure)|responsive|lag|freeze|virtualiz"]
scope: ["text", "thinking"]
---
