...
condition: ["frontend|client|browser|page|app|spa", "header|\\bmeta\\b|http (head)|request header|response header|security header", "content-security|csp|x-frame|frame-ancestors|iframe|cors|referrer|hsts|csrf|authorization|token"]
scope: ["text", "thinking"]
---
