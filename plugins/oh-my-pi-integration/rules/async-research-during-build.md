...
condition: ["research|investigate|search (for|the)|look up|check docs|find out", "while (implementing|working|building)|in the meantime|in parallel|separate agent|subagent|background (task|agent)", "verify (after|whether)|re-check|revisit"]
scope: ["text", "thinking"]
---
