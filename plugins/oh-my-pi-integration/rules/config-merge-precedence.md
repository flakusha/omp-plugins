...
condition: ["config|configuration|settings", "CLI|command[- ]line|flag|argument|option", "environment variable|env var|\\bENV\\b|process\\.env", "default|precedence|override|merge|deep merge|fallback", "example config|config example|sample"]
scope: ["text", "thinking"]
---
